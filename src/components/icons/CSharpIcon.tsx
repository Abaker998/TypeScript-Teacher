...
export default function CSharpIcon({ className = '', size = 24 }: CSharpIconProps) {
  return (
    <svg
      viewBox="0 0 128 128"
      width={size}
    ...
    >
      ...
      <path fill="#fff" d="M82 64h5v4h-5v5h-4v-5h-5v-4h5v-5h4v5zm18 0h5v4h-5v5h-4v-5h-5v-4h5v-5h4v5z"></path>
    </svg>
  );
}
