    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {lessonGroups.map((group) => (
              <div key={group.difficulty} className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  {group.lessons.map((lesson) => (
                    <li key={lesson.slug} className="text-gray-600">
                      • {lesson.title}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          {/* Beginner Callout */}
          <div className="mt-8 bg-purple-50 border-2 border-purple-200 rounded-lg p-6 text-center">
            <h3 className="text-xl font-semibold text-purple-900 mb-2">New to Programming?</h3>
